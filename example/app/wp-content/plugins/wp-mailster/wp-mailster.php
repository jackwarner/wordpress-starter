...
\*********************************************/
	...
	function mst_display_select_field($title, $name, $options = array(), $value, $placeholder = null, $required = false, $info = null, $readonlyOptions = array(), $disabled = false) {
		...
		<tr class="<?php if($required) { echo 'form-required'; } ?>" >
			...
			<td>
				<select name="<?php echo $name; ?>" id="<?php echo $name; ?>" <?php if ($required) { echo "required"; } ?> <?php if ($disabled) { echo 'disabled="disabled"'; } ?>  >
					<?php
						foreach ( $options as $key => $option_value ) {
							...
							<option value="<?php echo $key; ?>" <?php echo ($value== $key?'selected':''); ?> <?php echo $readonly; ?> ><?php echo $option_value; ?></option>
						<?php } ?>
				</select>
				<?php if ($required) { ?>
					<span class="mst_required">*</span>
	...
	function mst_display_simple_radio_field($name, $value, $id, $text, $checked = false, $required = false) {
		?>
		<label for="<?php echo $id; ?>">
			<input type='radio' name='<?php echo $name; ?>' id="<?php echo $id; ?>" <?php if($checked) echo 'checked'; ?> value="<?php echo $value; ?>">
			<?php echo $text; ?>
		</label>
		<?php
	}
